...
console.log("4 to the second power is: ");
console.log(4 ** 2);
...
console.log(13 + 8 / 2 - 1); //What will this equal? 16. Remember Order of Operations!

console.log("(13 + 8) / (2 - 1) = ")
console.log((13 - 8) / (2 - 1)); //What will this equal? 5. Is it the same as the previous line?
